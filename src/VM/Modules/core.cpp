...
REGISTER_MODULE( core )
{
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// basic arithmetic
	vm.funcs.add( { "&&",   2, 2, { "_any_", "_any_" }, FnType::MODULE, { .modfn = log_and } } );
	vm.funcs.add( { "||",   2, 2, { "_any_", "_any_" }, FnType::MODULE, { .modfn = log_or } } );
	vm.funcs.add( { "!=",   2, 2, { "_any_", "_any_" }, FnType::MODULE, { .modfn = log_not } } );
